...
class TrainLoop:
    ...
    def run_loop(self):
        ...
        while (
            ...
            threshold = 0.5
            import random
            p = random.uniform(0, 1) if classifier_free else 1
            
            batch = th.zeros_like(batch) if p < threshold else batch
    ...
    def save(self):
        ...
        if dist.get_rank() == 0:
            with bf.BlobFile(
                bf.join(get_blob_logdir(), "optsavedmodel.pt"),
                "wb",
            ) as f:
